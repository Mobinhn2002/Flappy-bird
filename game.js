...
var bird = {
    ...
    update : function(){
        ...
        if(this.animationIndex < 3){
            ...
            this.animationIndex = frames % period == 0 ? 0 : this.animationIndex;
        }
        ...
        if(state.current == state.getReady){
            ...
            this.y += this.speed;
            if(this.speed < 0){
                this.rotation = -24 * degree;
                this.birdDegree = -24;
            }else{
                this.birdDegree = this.birdDegree == 90 ? 90 : this.birdDegree += 3;
                this.rotation = this.birdDegree * degree;
            }
        }
